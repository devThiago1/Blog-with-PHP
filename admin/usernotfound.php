...
<body>
    ...
    <div class="container">
        ...
        <div class="container-message">
            <i class="bi bi-person-exclamation" style="font-size:100px;display: flex; justify-content:center; margin-top: 5%; "></i>
            <p class="fs-2 text" style="display: flex; justify-content: center;">Usuário não cadastrado</p>
        </div>
    </div>
</body>
</html>